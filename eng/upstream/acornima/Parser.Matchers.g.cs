...
partial class Parser
{
    ...
    private static partial Jint.TypeScript.Parsing.Parser.ReservedWordKind IsReservedWordES3NonStrict(System.ReadOnlySpan<char> word)
    {
        switch (word.Length)
        {
            case 3:
    ...
    private static partial Jint.TypeScript.Parsing.Parser.ReservedWordKind IsReservedWordES5NonStrict(System.ReadOnlySpan<char> word)
    {
        switch (word.Length)
        {
            case 4:
    ...
    private static partial Jint.TypeScript.Parsing.Parser.ReservedWordKind IsReservedWordES6NonStrict(System.ReadOnlySpan<char> word)
    {
        switch (word.Length)
        {
            case 4:
    ...
    private static partial Jint.TypeScript.Parsing.Parser.ReservedWordKind IsReservedWordES5Strict(System.ReadOnlySpan<char> word)
    {
        switch (word.Length)
        {
            case 3:
    ...
    internal static partial Jint.TypeScript.Parsing.Parser.ReservedWordKind IsReservedWordES6Strict(System.ReadOnlySpan<char> word)
    {
        switch (word.Length)
        {
            case 3:
