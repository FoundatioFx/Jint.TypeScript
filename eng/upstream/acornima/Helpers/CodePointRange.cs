...
namespace Jint.TypeScript.Parsing.Helpers;
...
internal readonly struct CodePointRange : IComparable<CodePointRange>
{
    ...
    public static ArrayList<CodePointRange> InvertRanges(ReadOnlySpan<CodePointRange> ranges, int start = 0, int end = UnicodeHelper.LastCodePoint)
    {
        if (ranges.Length == 0)
        {
    ...
    {
        public static readonly KeyValuePair<int, int> LetterCategory = new((int)UnicodeCategory.OtherNotAssigned + 1,
        ...
        public static readonly KeyValuePair<int, int> CasedLetterCategory = new((int)UnicodeCategory.OtherNotAssigned + 2,
            1 << (int)UnicodeCategory.UppercaseLetter
            | 1 << (int)UnicodeCategory.LowercaseLetter
            | 1 << (int)UnicodeCategory.TitlecaseLetter);

        public static readonly KeyValuePair<int, int> MarkCategory = new((int)UnicodeCategory.OtherNotAssigned + 3,
            1 << (int)UnicodeCategory.NonSpacingMark
            | 1 << (int)UnicodeCategory.SpacingCombiningMark
            | 1 << (int)UnicodeCategory.EnclosingMark);

        public static readonly KeyValuePair<int, int> NumberCategory = new((int)UnicodeCategory.OtherNotAssigned + 4,
            1 << (int)UnicodeCategory.DecimalDigitNumber
            | 1 << (int)UnicodeCategory.LetterNumber
            | 1 << (int)UnicodeCategory.OtherNumber);

        public static readonly KeyValuePair<int, int> PunctuationCategory = new((int)UnicodeCategory.OtherNotAssigned + 5,
        ...
        public static readonly KeyValuePair<int, int> SymbolCategory = new((int)UnicodeCategory.OtherNotAssigned + 6,
        ...
        public static readonly KeyValuePair<int, int> SeparatorCategory = new((int)UnicodeCategory.OtherNotAssigned + 7,
            1 << (int)UnicodeCategory.SpaceSeparator
            | 1 << (int)UnicodeCategory.LineSeparator
            | 1 << (int)UnicodeCategory.ParagraphSeparator);

        public static readonly KeyValuePair<int, int> OtherCategory = new((int)UnicodeCategory.OtherNotAssigned + 8,
        ...
        public static KeyValuePair<int, int> CategoryFrom(UnicodeCategory category)
        {
            return new KeyValuePair<int, int>((int)category, 1 << (int)category);
        }
        ...
        public CodePointRange[] GetGeneralCategory(KeyValuePair<int, int> category)
        {
            ...
            if (cachedRanges is null)
            {
                ...
                AddRanges(ref ranges, cp => (category.Value & (1 << (int)UnicodeHelper.GetUnicodeCategory(cp))) != 0);
