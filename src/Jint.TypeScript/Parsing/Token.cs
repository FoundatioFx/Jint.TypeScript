...
internal readonly struct Token
{
    ...
    /// * <see cref="TokenKind.RegExpLiteral"/> => <see cref="Jint.TypeScript.Parsing.RegExpValue"/><br/>
    /// * <see cref="TokenKind.Template"/> => <see cref="Jint.TypeScript.Parsing.TemplateValue"/><br/>
    ...
    public object? Value => Kind switch
    {
        ...
        TokenKind.Template => Acornima.TemplateValue.From(_value.TemplateCooked, (string)_value.Value!),
    ...
    public TemplateValue? TemplateValue { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => Kind == TokenKind.Template ? Acornima.TemplateValue.From(_value.TemplateCooked, (string)_value.Value!) : null; }
    ...
    public override string ToString()
    {
        return Kind switch
        {
            ...
            TokenKind.Template => $"{Kind} ({Acornima.TemplateValue.From(_value.TemplateCooked, (string)_value.Value!)})",
