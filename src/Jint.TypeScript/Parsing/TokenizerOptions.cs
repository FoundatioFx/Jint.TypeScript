...
internal delegate void OnTokenHandler(in Token token);

internal delegate void OnCommentHandler(in Comment comment);

internal delegate RegExpParseResult OnRegExpHandler(in RegExpParsingContext context);

internal record class TokenizerOptions
{
