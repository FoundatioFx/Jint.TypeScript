...
internal delegate void OnInsertedSemicolonHandler(int lastTokenEnd, Position lastTokenEndLocation);

internal delegate void OnTrailingCommaHandler(int lastTokenEnd, Position lastTokenEndLocation);

internal delegate void OnNodeHandler(Node node, in OnNodeContext context);
...
internal record class ParserOptions
{
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    /// </remarks>
    public OnRegExpHandler? OnRegExp { get => _tokenizerOptions._onRegExp; init => _tokenizerOptions._onRegExp = value; }
